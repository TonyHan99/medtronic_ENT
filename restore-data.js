...
const subscribers = [
  ...
  { company: '메드트로닉', email: 'pky@dkls.co.kr', name: '박근열', phone: '' },
  { company: '메드트로닉', email: 'pih@dkls.co.kr', name: '박인환', phone: '' },
  ...
  { company: '메드트로닉', email: 'garuta77@naver.com', name: '김창현', phone: '' },
  ...
  { company: '메드트로닉', email: 'jhs@dkls.co.kr', name: '정희석', phone: '' },
